...
- **Security Vulnerabilities**: 57 found in 5 packages
...
| `urllib3` | Transitive (via requests) | `==1.26.15` | `1.26.15` | `2.7.0` | ❌ Major Update | ⚠️ **11** |  |

## Security Vulnerabilities Details

### `certifi@2022.12.7` (via requests) (4 vulnerabilities)

- **GHSA-248v-346w-9cwc** [LOW]: Certifi removes GLOBALTRUST root certificate
...
- **GHSA-xqr8-7jwr-rhp7** [CVSS CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N]: Removal of e-Tugra root certificate
...
- **PYSEC-2023-135** [UNKNOWN]: No summary provided
...
- **PYSEC-2024-230** [CVSS CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:H/A:N]: No summary provided
  > Certifi is a curated collection of Root Certificates for validating the trustworthiness of SSL certificates while verifying the identity of TLS hosts. Certifi starting in 2021.05.30 and prior to 2024.07.4 recognized root certificates from `GLOBALTRUST`. Certifi 2024.07.04 removes root certificates from `GLOBALTRUST` from the root store. These are in the process of being removed from Mozilla's trust store. `GLOBALTRUST`'s root certificates are being removed pursuant to an investigation which identified "long-running and unresolved compliance issues."

### `django@4.0.0` (33 vulnerabilities)

- **GHSA-2gwj-7jmv-h26r** [CVSS CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H]: SQL Injection in Django
...
### `urllib3@1.26.15` (via requests) (11 vulnerabilities)
...
- **GHSA-pq67-6m6q-mj2v** [CVSS CVSS:3.1/AV:N/AC:H/PR:L/UI:N/S:U/C:H/I:N/A:N]: urllib3 redirects are not disabled when retries are disabled on PoolManager instantiation
